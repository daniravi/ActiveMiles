...
network = torch.load('Ear-Ws-1Rnd-5Sec-cs1model.net','apkbinary64'):float()
print('OK Ear 1')
mean = torch.load('Ear-Ws-1Rnd-5Sec-cs1avg.dat','apkbinary64')
print('OK Ear  2')
std = torch.load('Ear-Ws-1Rnd-5Sec-cs1std.dat','apkbinary64')
print('OK Ear  3')
network:float()
network:evaluate();
