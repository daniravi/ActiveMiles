...
public class DeviceListActivity extends Activity {
    ...
    private static final long SCAN_PERIOD = 10000;                // 10
    // seconds
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d(TAG, "onCreate");
        getWindow().setFeatureInt(Window.FEATURE_CUSTOM_TITLE, R.layout.title_bar_bluetooth);
    ...
    private final ScanCallback mLeScanCallback2 = new ScanCallback() {
        @Override
    ...
    class DeviceAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (rssival != 0) {
                tvrssi.setText(getString(R.string.RSSI) + String.valueOf(rssival));
            }
